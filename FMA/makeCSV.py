...
def makeCSV(partLength = 5, genresOfLibrary ='electronic experimental folk hiphop instrumental international pop rock'):
    ...
    for g in genres:
        filenamewhohidden = (filename for filename in os.listdir(f'fma_small_wav/{g}') if not filename.startswith('.'))
